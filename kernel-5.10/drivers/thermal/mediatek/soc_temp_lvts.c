...
static struct tc_settings mt6789_tc_settings[] = {
	[MT6789_LVTS_AP_CTRL0] = {
		...
		.hw_filter = LVTS_FILTER_1,
		.dominator_sensing_point = SENSING_POINT1,
		/*HS07 code for HS07-355 by yexuedong at 20250407 start*/
		/*HST11 code for AX7800A-865 by huofudong at 20250523 start*/
		#if defined(CONFIG_CUSTOM_PROJECT_HS07) || defined(CONFIG_CUSTOM_PROJECT_HST11)
		#ifdef CONFIG_ODM_CUSTOM_D85_BUILD
		.hw_reboot_trip_point = 130000,
		#else
		.hw_reboot_trip_point = 113500,
		#endif
		#else
		.hw_reboot_trip_point = 113500,
		#endif
		/*HST11 code for AX7800A-865 by huofudong at 20250523 end*/
		/*HS07 code for HS07-355 by yexuedong at 20250407 end*/
		.irq_bit = BIT(1),
		.coeff = {
			.a = {-250460},
			.cali_mode = CALI_NT,
