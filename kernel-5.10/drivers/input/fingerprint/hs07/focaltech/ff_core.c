...
#endif
#if IS_ENABLED(CONFIG_DRM_MEDIATEK)
        mtk_disp_notifier_unregister(&ff_ctx->mtk_drm_notif);
#endif//CONFIG_DRM_MEDIATEK
    }
/*HS07 code for HS07-955 by hehaoran at 20250418 end*/
...
static long ff_ctl_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    /* HS07 code for SR-AL7761A-01-172 by hehaoran at 20250317 start*/
    finger_sysfs = 0x04;
    /* HS07 code for SR-AL7761A-01-172 by hehaoran at 20250317 end*/
    switch (cmd) {
