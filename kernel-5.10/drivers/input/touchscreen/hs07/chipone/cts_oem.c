...
/*HS07 code for SR-AL7761A-01-588 by guyuming at 20250319 start*/
#define OEM_OF_PROPNAME_PREFIX              "," //modify
#define ITO_NODE_LEN    128
/*HS07 code for SR-AL7761A-01-588 by guyuming at 20250319 end*/
...
{
    /*HS07 code for SR-AL7761A-01-588 by guyuming at 20250319 start*/
    struct chipone_ts_data *chipone_data = oem_data->cts_data;
    char ito_node_name [ITO_NODE_LEN] = {0};
    int ret;

    cts_info("Parse selftest dt");
    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1,"%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_RESET_PIN );
    /** reset pin **/
    oem_data->test_reset_pin = OEM_OF_DEF_PROPVAL_TEST_RESET_PIN ||
        of_property_read_bool(np, ito_node_name);

    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_INT_PIN );
    /** int pin **/
    oem_data->test_int_pin = OEM_OF_DEF_PROPVAL_TEST_INT_PIN ||
        of_property_read_bool(np, ito_node_name);

    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_RAWDATA );
    /** rawdata **/
    ...
    if (oem_data->test_rawdata) {
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_RAWDATA_FRAMES );
        ret = of_property_read_u32(np, ito_node_name,
                &oem_data->rawdata_test_frames);
        if (ret) {
            cts_warn("Parse %s failed %d", ito_node_name,ret);
        }
        oem_data->rawdata_min = OEM_OF_DEF_PROPVAL_RAWDATA_MIN;
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_RAWDATA_MIN );
        ret = of_property_read_u32(np, ito_node_name,
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_RAWDATA_MAX );
        ret = of_property_read_u32(np, ito_node_name,
    ...
    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_NOISE );
    /** nosie **/
    ...
    if (oem_data->test_noise) {
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_NOISE_FRAMES );
        ret = of_property_read_u32(np, ito_node_name,
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_NOISE_MAX );
        ret = of_property_read_u32(np, ito_node_name,
    ...
    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_OPEN );
    /** open **/
    ...
    if (oem_data->test_open) {
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_OPEN_MIN );
        ret = of_property_read_u32(np, ito_node_name,
    ...
    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_SHORT );
    /** short **/
    ...
    if (oem_data->test_short) {
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_SHORT_MIN );
        ret = of_property_read_u32(np, ito_node_name,
    ...
    memset(ito_node_name, 0, sizeof(ito_node_name));
    snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_TEST_COMP_CAP );
    /** comp cap **/
    ...
    if (oem_data->test_comp_cap) {
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_COMP_CAP_MIN );
        ret = of_property_read_u32(np, ito_node_name,
        ...
        memset(ito_node_name, 0, sizeof(ito_node_name));
        snprintf(ito_node_name, sizeof(ito_node_name)-1, "%s%s", chipone_data->module_name,OEM_OF_PROPNAME_COMP_CAP_MAX );
        ret = of_property_read_u32(np, ito_node_name,
...
{
    time64_t now_time = ktime_get_real_seconds();
    struct rtc_time rtc_now_time;
    static char time_data_buf[TIME_DATA_BUF_LEN] = { 0 };

    rtc_time64_to_tm(now_time, &rtc_now_time);
...
static int save_selftest_data_to_file(struct cts_oem_data *oem_data)
{
    ...
    snprintf(timestamp,sizeof(timestamp)-1,"%s",get_date_time_str());
    ...
    snprintf(filepath, sizeof(filepath), "%s_%s_%s_%s.csv", OEM_RAWDATA_TEST_DATA_FILEPATH, timestamp,oem_data->cts_data->module_name,
    ...
    snprintf(filepath, sizeof(filepath),"%s_%s_%s_%s.csv", OEM_NOISE_TEST_DATA_FILEPATH, timestamp,oem_data->cts_data->module_name,
    ...
    snprintf(filepath, sizeof(filepath), "%s_%s_%s_%s.csv", OEM_OPEN_TEST_DATA_FILEPATH, timestamp,oem_data->cts_data->module_name,
    ...
    snprintf(filepath, sizeof(filepath), "%s_%s_%s_%s.csv", OEM_SHORT_TEST_DATA_FILEPATH, timestamp,oem_data->cts_data->module_name,
    ...
    snprintf(filepath, sizeof(filepath), "%s_%s_%s_%s.csv", OEM_COMP_CAP_TEST_DATA_FILEPATH, timestamp,oem_data->cts_data->module_name,
