...
/* Flash read write */
#define IOC_FLASHDOWNLOAD_BIN                _IOW(GALAXYCORE_MAGIC_NUMBER, 23, char)
#define IOC_START_READ_FLASH_DATA           _IOW(GALAXYCORE_MAGIC_NUMBER, 24, char)
#define IOC_SET_FLASHREAD_PARAMETERS        _IOW(GALAXYCORE_MAGIC_NUMBER, 25, unsigned int[2])
