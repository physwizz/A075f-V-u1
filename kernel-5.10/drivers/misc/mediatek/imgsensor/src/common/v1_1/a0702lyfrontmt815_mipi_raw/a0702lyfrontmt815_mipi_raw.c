...
#include "a0702lyfrontmt815_mipi_raw.h"

#define PFX "a0702lyfrontmt815_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = A0702LYFRONTMT815_SENSOR_ID,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if (enable)
    {
        ...
        write_cmos_sensor(0x05ef,0xff);
        write_cmos_sensor(0x05f0,0xff);
        write_cmos_sensor(0x05f1,0xff);
        write_cmos_sensor(0x05f2,0xff);
        write_cmos_sensor(0x05f3,0xff);
        write_cmos_sensor(0x05f4,0xff);
        write_cmos_sensor(0x05f5,0x03);
...
{
    LOG_INF("A0702LYFRONTMT815_MIPI_RAW_SensorInit\n");
    if (pfFunc!=NULL)
            *pfFunc=&sensor_func;
    return ERROR_NONE;
}
