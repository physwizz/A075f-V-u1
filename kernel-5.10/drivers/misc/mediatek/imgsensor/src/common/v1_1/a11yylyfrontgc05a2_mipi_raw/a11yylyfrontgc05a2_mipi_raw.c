 ...
 */
#define PFX "a11yylyfrontgc05a2_camera_sensor"
...
#include "a11yylyfrontgc05a2_mipi_raw.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A11YYLYFRONTGC05A2_SENSOR_ID,
...
//#if A11YYLYFRONTGC05A2_MIRROR_NORMAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
//#elif A11YYLYFRONTGC05A2_MIRROR_H
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
//#elif A11YYLYFRONTGC05A2_MIRROR_V
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
//#elif A11YYLYFRONTGC05A2_MIRROR_HV
...
kal_uint16 a11yylyfrontgc05a2_init_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
/*pre_setting*/
	...
	0x0d06, 0x01,
	0x0007, 0x16,
	0x0101, A11YYLYFRONTGC05A2_MIRROR,
/*analog*/
	0x0342, 0x07,
	0x0343, 0x28,
	0x0220, 0x07,
...
static kal_uint16 a11yylyfrontgc05a2_1296x972_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 a11yylyfrontgc05a2_2592x1944_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 a11yylyfrontgc05a2_1280x720_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(a11yylyfrontgc05a2_init_addr_data,
		sizeof(a11yylyfrontgc05a2_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(a11yylyfrontgc05a2_1296x972_addr_data,
		sizeof(a11yylyfrontgc05a2_1296x972_addr_data)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(a11yylyfrontgc05a2_2592x1944_addr_data,
		sizeof(a11yylyfrontgc05a2_2592x1944_addr_data)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(a11yylyfrontgc05a2_1280x720_addr_data,
		sizeof(a11yylyfrontgc05a2_1280x720_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[a11yylyfrontgc05a2_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[a11yylyfrontgc05a2_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[a11yylyfrontgc05a2_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[a11yylyfrontgc05a2_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
