 ...
 */
#define PFX "CAM_CAL_a0702lyfrontmt815"
...
struct a0702lyfrontmt815_otp_struct
{
...
static int a0702lyfrontmt815_read_otp(struct i2c_client *client,
				u32 start_addr, u8 *data, u32 otp_len)
{
	...
	printk("a0702lyfrontmt815_read_otp start_addr = %x size = %d data read = %d\n", start_addr, otp_len, rtn);
...
unsigned int a0702lyfrontmt815_read_region(struct i2c_client *client, unsigned int addr,
				unsigned char *data, unsigned int size)
{
	...
	if (a0702lyfrontmt815_read_otp(client, addr, data, size) == 0)
		return size;
	else
		return 0;
}
